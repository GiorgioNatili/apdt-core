...
public class ImplementsAddOperation extends AbstractNodeOperation {
	private TypeReference source;

	public ImplementsAddOperation(ModelContext context, Object parent,
			NodeType nodeType, NodeMoveProvider moveProvider,
			Neighbor neighbor, boolean before) {
		super("Implements-Operation", context, parent, nodeType, moveProvider,
				neighbor, before);
	}
	...
	private AbstractNode<?> createNode() {
		...
		if (neighbor != null && moveProvider != null
			...
			element.getImplementsElements().add(source);
		}
