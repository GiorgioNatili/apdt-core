...
public class FinallyGroupNode extends GroupNode implements NodeOverview {
	private final TrySequence trySequence;

	public FinallyGroupNode(AbstractNode<?> parent, TrySequence trySequence,
			final SequenceGroup provider,
	...
	public String getName() {
		return APDEditorMessages.TreeNode_finally;
	}

	@Override
	public String getNote() {
		return APDNodeHelpMessages.getNLS("editor.help.finally");
	}

	@Override
	public ImageDescriptor getImageDescriptor() {
		return APDEditorImages.DESC_MODEL_SEQN_FINALLY;
	}
